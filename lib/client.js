window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const en = {
			...
			"settings.openOptions": "Show available options",
		...
		*/
		function AliasSelector(props) {
			const { available, aliases, directory, loadDirectory, select, t, useSession } = props;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					"aria-expanded": open,
					disabled: locked,
					title: currentAlias === void 0 ? t("selector.custom") : routeLabel(currentAlias),
					onClick: openMenu,
		...
		function SettingsCombobox({ value, options, disabled = false, ariaLabel, openOptionsLabel, placeholder, onInput, onSelect }) {
			const [open, setOpen] = (0, react.useState)(false);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				selectedId: selected ? value : void 0,
				onClose: () => setOpen(false),
				onSelect: (next) => {
					setOpen(false);
					onSelect(next);
				...
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dma-combobox__control",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: "dma-combobox__chevron" })
					})]
				})
			});
		}
		...
		function AliasSettingsSection(props) {
			...
			const sessionState = (0, react.useSyncExternalStore)((listener) => sessionList.subscribe(listener), () => sessionList.getSnapshot());
						...
						children: [draft.length === 0 && !loading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dma-field",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("settings.provider") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsCombobox, {
											...
											onInput: (provider) => replaceAt(index, {
												...alias,
												provider
											}),
											onSelect: (provider) => {
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dma-field",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("settings.model") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsCombobox, {
											value: alias.model,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dma-field",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("settings.effort") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingsCombobox, {
...
.dma-combobox__control{box-sizing:border-box;display:flex;width:100%;min-width:0;height:36px;align-items:center;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);border-radius:10px}
...
.dma-field .dma-combobox__control input{height:34px;padding-right:4px;background:transparent;border:0}
.dma-field .dma-combobox__control input:hover:not(:disabled),.dma-field .dma-combobox__control input:focus{border-color:transparent}
.dma-combobox__trigger{box-sizing:border-box;display:flex;width:34px;height:34px;flex:none;align-items:center;justify-content:center;padding:0;color:var(--dsw-alias-label-caption);background:transparent;border:0;border-radius:0 9px 9px 0;cursor:pointer}
...
`;
		...
		function apply(ctx) {
			...
			const loadCatalog = async (sessionId) => {
				if (sessions.subagentAddress(sessionId) !== void 0) throw new Error("被寻址的子代理会话不支持模型选择");
